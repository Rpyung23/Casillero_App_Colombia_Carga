...
import 'package:locker/src/pages/document/detail_document.dart';
import 'package:locker/src/style/theme.dart' as Style;
import 'package:locker/src/utils/icon_from_string_util.dart';

class ListTransito extends StatefulWidget {
  final String? type;
  ListTransito({Key? key, required this.type}) : super(key: key);

  @override
  _ListTransitoState createState() => _ListTransitoState();
}

class _ListTransitoState extends State<ListTransito> {
