...
import 'package:locker/src/bloc/document_detail_bloc/document_detail_bloc.dart';
...
class DetailTransito extends StatefulWidget {
  final String? numDocument;

  const DetailTransito({Key? key, required this.numDocument}) : super(key: key);
  @override
  _DetailTransitoState createState() => _DetailTransitoState();
}

class _DetailTransitoState extends State<DetailTransito> {
